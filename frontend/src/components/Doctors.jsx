...
<div className='w-45 h-45 rounded-full bg-white'>
                    ...
                    <h4 className='font-bold text-5xl'>Dr. Arun Kumar Balakrishnan</h4>
...
<div className='w-45 h-45 rounded-full bg-white'></div>
                    <h4 className='font-bold text-xl'>Dr. D. Venkat Subramaniam
                    </h4>
                    <div className='text-center'>
                        <span>
                            M.S, D.Lap, M.Ch(Uro)
...
<div className='w-45 h-45 rounded-full bg-white'></div>
                    <h4 className='font-bold text-xl'>Dr. Navinath M</h4>
                    <div className='text-center'>
